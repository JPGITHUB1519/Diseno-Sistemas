...
namespace diseno_sistemas
{
    public partial class Principal : Form
    {
        ...
        private void debCreToolStripMenuItem_Click(object sender, EventArgs e)
        {
            NDebCre doform = new NDebCre();
            doform.MdiParent = this;
            doform.Show();
        }
        ...
        {
            frmEstdoCuenta doform = new frmEstdoCuenta();
            doform.MdiParent = this;
            doform.Show();
        }
        ...
        {
            frmpermisos doform = new frmpermisos();
            doform.MdiParent = this;
            doform.Show();
        }
